<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Orphanage.Default" %>
...
<body style="background-image:url(imgs/orphanage1.jpg);background-repeat:no-repeat;background-size:cover">
  ...
  <div style="width:750px; height:80px; margin: 0 auto; overflow:hidden; position:relative">
        ...
        <div id="caption" style="height:44px; margin-top:20px;float:left; margin-left:12px; position:absolute"> Collins' Orphanage </div>
